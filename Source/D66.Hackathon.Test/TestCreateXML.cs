...
namespace D66.Hackathon.Test
{
	...
	public class TestCreateXML
	{
		...
		public void CreateXML()
		{
			...
			election.Type = ElectionType.GR;
			election.SubdivisionType = SubdivisionType.Stemlokaal;
			using (var stream = File.Create(@"C:\Projects\D66\Hackathon\D66.Hackathon.Web\App_Data\\Elections\GR2014_0344.xml"))
			{
